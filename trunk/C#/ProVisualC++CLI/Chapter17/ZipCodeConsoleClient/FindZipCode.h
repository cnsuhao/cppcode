...
namespace FindZipCode {
    ...
    System::Web::Services::WebServiceBindingAttribute(Name=L"FindZipCodeClassSoap", Namespace=L"http://procppcli.net")]
    public ref class FindZipCodeClass : public System::Web::Services::Protocols::SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public: [System::Web::Services::Protocols::SoapDocumentMethodAttribute(L"http://procppcli.net/GetZip", RequestNamespace=L"http://procppcli.net", 
            ResponseNamespace=L"http://procppcli.net", Use=System::Web::Services::Description::SoapBindingUse::Literal, ParameterStyle=System::Web::Services::Protocols::SoapParameterStyle::Wrapped)]
...
namespace FindZipCode {
    ...
    inline FindZipCodeClass::FindZipCodeClass() {
        this->Url = L"http://localhost/FindZipCodeWS/FindZipCode.asmx";
    }
