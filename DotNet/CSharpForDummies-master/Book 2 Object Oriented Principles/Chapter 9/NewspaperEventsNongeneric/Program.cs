// NewspaperEventsNongeneric - Demonstrate using an event to notify multiple
...
//    Identical to the NewspaperEvents example except that this one avoids
//    using the EventHandler<TEventArgs> delegate type and uses the older,
//    simpler nongeneric form EventHandler.
//    Note that Microsoft recommends the generic form.
using System;

namespace NewspaperEventsNongeneric
{
  class Program
  {
  ...
  class Publisher
  {
    ...
    public event EventHandler NewEdition;
  ...
  class Subscriber
  {
    ...
    public void Subscribe(Publisher p)
    {
      ...
      p.NewEdition += new EventHandler(this.NewEditionPublished);
    }
