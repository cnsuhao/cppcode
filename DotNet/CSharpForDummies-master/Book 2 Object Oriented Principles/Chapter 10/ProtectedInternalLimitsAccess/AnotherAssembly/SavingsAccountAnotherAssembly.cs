...
namespace AnotherAssembly
{
  ...
  public class SavingsAccountAnotherAssembly : MainBankAccountAssembly.BankAccount
  {
    public override void Deposit(decimal amount)
    {
      ...
      Console.WriteLine("In SavingsAccountAnotherAssembly.Deposit, balance is {0}", Balance);
      base.Deposit(amount);
    }
    ...
    public override decimal Withdraw(decimal amount)
    {
      ...
      this.Balance -= 1M;
      // Second, display the modified balance, showing we can use Balance's get accessor here.
      Console.WriteLine("In SavingsAccountAnotherAssembly.Withdraw, balance is {0}", Balance);
