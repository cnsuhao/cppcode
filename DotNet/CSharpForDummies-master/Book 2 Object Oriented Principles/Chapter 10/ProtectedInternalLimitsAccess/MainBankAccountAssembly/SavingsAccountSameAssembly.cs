...
namespace MainBankAccountAssembly
{
  ...
  public class SavingsAccountSameAssembly : BankAccount
  {
    public override void Deposit(decimal amount)
    {
      ...
      Console.WriteLine("In SavingsAccountSameAssembly.Deposit, balance is {0}", Balance);
      base.Deposit(amount);
    }
    ...
    public override decimal Withdraw(decimal amount)
    {
      ...
      this.Balance -= 1M;
      // Second, display the modified balance, showing we can use Balance's get accessor here.
      Console.WriteLine("In SavingsAccountSameAssembly.Withdraw, balance is {0}", Balance);
